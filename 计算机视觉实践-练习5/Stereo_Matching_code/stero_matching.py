...
import numpy as np
import stereoCamera
#from stereoCamera import stereoCamera  # 导入相机标定的参数
...
if __name__ == '__main__':
    ...
    string = 'Val'
    # 读取数据集的图片
    iml = cv2.imread('./image_file/left.jpg' )  # 左图
    imr = cv2.imread('./image_file/right.jpg')  # 右图
    ...
    # 读取相机内参和外参
    config = stereoCamera.stereoCamera()
